...
2. Start running TF Serving and load the model:
    ...
    nohup tensorflow_model_server   --rest_api_port=8501   --model_name=fashion_model   --model_base_path="/home/dorian/work/src/PycharmProjects/tf_tests/models/fashionModel" >server.log 2>&1
